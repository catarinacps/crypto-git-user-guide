...
porém, embora direta ao ponto, existem alguns detalhes para esse processo.

Claro, o processo de adição ou remoção de participantes é direto:
...
através do comando =gpgp --list-keys --keyid-format long=.

Para finalmente atualizarmos o repositório e, efetivamente, adicionar esses
